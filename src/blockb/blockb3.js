...
function Floorb3() {
  ...
  return (
    <div style={containerStyle}>
      <h2 style={h2Style}>Welcome to Build B - Floor 3</h2>
      <h3 style={h3Style}>Information Technology Center and Ethiopian Constraction Corporation</h3>
      ...
      <ul style={listStyle}><h3>our Servise</h3>
        ...
        <li>Mobile applijcation development</li>
         <li>E-electronics Invice testing</li>
          <li>Api testing</li>
           <li>system develop and suport</li>
            <li>Projects participate</li>
      </ul>
